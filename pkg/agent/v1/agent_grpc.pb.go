...
const (
	AgentService_Connect_FullMethodName = "/smidr.agent.v1.AgentService/Connect"
)
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "smidr.agent.v1.AgentService",
