...
func initProject(projectName string) error {
	...
	log.Info("Edit agent.yaml to configure your build")
...
name: %s
description: "Smidr Agent"
version: "0.1.0"
serverConfig:
  port: "50051" # Host and port for the Smidr Agent server
  address: "" # Address for the Smidr daemon to listen on
